...
<figure>
  <img src="classification-tree.PNG" alt="arbol basico de clasificacion"/>
  <figcaption>Un árbol de decisión para clasificar flores según sus dimensiones. Fuente: Documentación de Scikit-learn.</figcaption>
</figure>
...
<figure>
  <img src="basic-tree.PNG" alt="arbol basico" />
  <figcaption>
    En el panel de arriba a la izquiera se muestra una partición ideal, y el de
    abajo a la izquierda un arbol de decisión intentando aproximarse a ésta. En
    el panel de arriba a la derecha se muestra el espacio que resulta de este
    árbol, y abajo a la derecha la superficie de predicción. Fuente: Elements of
